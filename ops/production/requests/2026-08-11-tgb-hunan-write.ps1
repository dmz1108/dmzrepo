# DreamerQi production operation: write the manually transcribed 2026-08-11
# official @TGB Hunan table, rebuild the same-day combined reason database,
# and verify the public source view.
#
# The 58 formal rows are supplied only through a date-bound encrypted GitHub
...
# all 58 review-eligible terminal-pool rows, backs up every touched artifact,
...
$expectedPayloadSha256 = 'ae38fff1ba9dc82f97e0da82974916640f12bb2a7086aa590524082caaff80bf'
...
const articleUrl = 'https://www.tgb.cn/a/2uaVmOBLE3q';
const articleTitle = '8.11\u6e56\u5357\u4eba\u6da8\u505c\u590d\u76d8+\u665a\u95f4\u6d88\u606f\u6c47\u603b';
const imageFile = 'image-01-06.png';
const imageUrl = 'https://image.tgb.cn/img/2026/08/11/v8bhxz0353ht.png_760w.png';
const expectedImageLength = 664637;
const expectedImageSha256 = '920f47c5e73c9b034e1c66caa7fea5873a691a078de6f1aa648f7fbb2c924f5c';
const expectedCount = 58;
const expectedRawPoolCount = 58;
const expectedExcludedCodes = [];
const operationId = 'tgb-hunan-manual-20260811';
