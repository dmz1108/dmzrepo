# DreamerQi production operation: write the manually transcribed 2026-08-13
# official @TGB Hunan table, rebuild the same-day combined reason database,
# and verify the public source view.
#
# The 59 formal rows are supplied only through a date-bound encrypted GitHub
...
# all 59 review-eligible terminal-pool rows, backs up every touched artifact,
...
$expectedPayloadSha256 = '3e76d4cc38e0b97955b73748a2b1f4f01a4f17a9f3c08279c331e7438f5b4b80'
...
const articleUrl = 'https://www.tgb.cn/a/2uec4Zbbvhb';
const articleTitle = '8.13\u6e56\u5357\u4eba\u6da8\u505c\u590d\u76d8+\u665a\u95f4\u6d88\u606f\u6c47\u603b';
const imageFile = 'image-01-06.png';
const imageUrl = 'https://image.tgb.cn/img/2026/08/13/1vsmj7jrxvnm.png_760w.png';
const expectedImageLength = 817029;
const expectedImageSha256 = '90afc9e94f7b2f65d18be2c7760b4b4b7c661b7afa8f27adb1758b9a026d723b';
const expectedCount = 59;
const expectedRawPoolCount = 59;
const expectedExcludedCodes = [];
const operationId = 'tgb-hunan-manual-20260813';
