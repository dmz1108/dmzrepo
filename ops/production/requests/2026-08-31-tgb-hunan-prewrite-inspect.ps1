...
# 2026-08-31 @TGB Hunan manual review.
#
...
$day = '2026-08-31'
$expectedEligibleCount = 86
$baselineFile = Join-Path $project 'kpl-limitup-db\2026-08-31.json'
$formalFile = Join-Path $project 'kpl-limitup-main-reason-sources\tgb-hunan-structured\2026-08-31.json'
