# DreamerQi production operation: write the manually transcribed 2026-08-14
# official @TGB Hunan table, rebuild the same-day combined reason database,
# and verify the public source view.
#
# The 62 formal rows are supplied only through a date-bound encrypted GitHub
...
# all 62 review-eligible terminal-pool rows, backs up every touched artifact,
...
$expectedPayloadSha256 = 'f09bc66c7d4c76b30bae9146678cbc85292534d2529cc35cd77f00c8d3ea375c'
...
const articleUrl = 'https://www.tgb.cn/a/2ug1eFTWduG';
const articleTitle = '8.14\u6e56\u5357\u4eba\u6da8\u505c\u590d\u76d8+\u665a\u95f4\u6d88\u606f\u6c47\u603b';
const imageFile = 'image-01-06.png';
const imageUrl = 'https://image.tgb.cn/img/2026/08/14/f3cula4hywnm.png_760w.png';
const expectedImageLength = 680547;
const expectedImageSha256 = 'aeb1a552f77c48f819eadd481acd24664aa09afff219d9f1fdcf8d6ef6c51271';
const expectedCount = 62;
const expectedRawPoolCount = 63;
const expectedExcludedCodes = ['920083'];
const operationId = 'tgb-hunan-manual-20260814';
