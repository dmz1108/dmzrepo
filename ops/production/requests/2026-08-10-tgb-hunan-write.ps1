# DreamerQi production operation: write the manually transcribed 2026-08-10
# official @TGB Hunan table, rebuild the same-day combined reason database,
# and verify the public source view.
#
# The 99 formal rows are supplied only through a date-bound encrypted GitHub
...
# all 99 review-eligible terminal-pool rows, backs up every touched artifact,
...
$expectedPayloadSha256 = 'ecd2961959cea9c5adf7bd4d39f4560a0e5232869a733edc94cae6e585d2aa14'
...
const articleUrl = 'https://www.tgb.cn/a/2u9gsG5ttv0';
const articleTitle = '8.10\u6e56\u5357\u4eba\u6da8\u505c\u590d\u76d8+\u665a\u95f4\u6d88\u606f\u6c47\u603b';
const imageFile = 'image-01-06.png';
const imageUrl = 'https://image.tgb.cn/img/2026/08/10/xidb4ounpqsm.png_760w.png';
const expectedImageLength = 874636;
const expectedImageSha256 = '6e6c3a709d5e48660348474cb830c64d7b8c879c5bc2cdd419f48a96d9012887';
const expectedCount = 99;
const expectedRawPoolCount = 99;
const expectedExcludedCodes = [];
const operationId = 'tgb-hunan-manual-20260810';
