...
# 2026-08-26 @TGB Hunan manual review.
#
...
$day = '2026-08-26'
$expectedEligibleCount = 52
$baselineFile = Join-Path $project 'kpl-limitup-db\2026-08-26.json'
$formalFile = Join-Path $project 'kpl-limitup-main-reason-sources\tgb-hunan-structured\2026-08-26.json'
