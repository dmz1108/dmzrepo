# DreamerQi production operation: write the manually transcribed 2026-07-29
...
$expectedPayloadSha256 = 'd4f551aff55ffe35b1563e34a51959d4e7908448122f083790f1753078e056a4'
...
const articleUrl = 'https://www.tgb.cn/a/2tPnCn1JGfJ';
const articleTitle = '7.29\u6e56\u5357\u4eba\u6da8\u505c\u590d\u76d8+\u665a\u95f4\u6d88\u606f\u6c47\u603b';
const imageFile = 'image-01-06.png';
const imageUrl = 'https://image.tgb.cn/img/2026/07/29/u62jrcfbox6h.png_760w.png';
const expectedImageLength = 823290;
const expectedImageSha256 = 'b54b3e3a80d8f97c25d019d34a184c4ad7fef76185bded81cb3efd6e614f1810';
const expectedCount = 81;
const expectedRawPoolCount = 81;
const expectedExcludedCodes = [];
const operationId = 'tgb-hunan-manual-20260729';
