# DreamerQi production operation: write the manually transcribed 2026-09-21
# official @TGB Hunan table, rebuild the same-day combined reason database,
# and verify the public source view.
#
# The 101 formal rows are supplied through a temporary payload transferred
# over SSH. They are not tracked in Git or printed here.
# The script verifies the payload and official-image SHA-256 values, reconciles
# all 101 review-eligible terminal-pool rows, backs up every touched artifact,
...
$expectedPayloadSha256 = '58207c8bf0903824f535f5ea595551e813672a8a5b4df5ef1e3223a4bd717d34'
...
const articleUrl = 'https://www.tgb.cn/a/2vh089euxrD';
const articleTitle = '9.21\u6e56\u5357\u4eba\u6da8\u505c\u590d\u76d8+\u665a\u95f4\u6d88\u606f\u6c47\u603b';
const imageFile = 'image-01-06.png';
const imageUrl = 'https://image.tgb.cn/img/2026/09/21/rmsyh0jf01sx.png_760w.png';
const expectedImageLength = 1063566;
const expectedImageSha256 = 'c7ef69d1f9e4e51a42d049311e67f22d37ad344063aeceee65fc06ebaede48ed';
const expectedCount = 101;
const expectedRawPoolCount = 103;
const expectedExcludedCodes = ['920427', '920478'];
const operationId = 'tgb-hunan-manual-20260921';
...
const expectedNameDifferences = [
  { code: '000020', sourceName: "\u6df1\u534e\u53d1A", baselineName: "\u6df1\u534e\u53d1\uff21", normalization: 'NFKC+remove-whitespace' },
  { code: '000402', sourceName: "\u91d1\u878d\u8857", baselineName: "\u91d1 \u878d \u8857", normalization: 'NFKC+remove-whitespace' },
];
...
function validatePayload(payload, baselineGate) {
  ...
  const expectedTopics = Object.fromEntries(expectedManualBlocks);
...
(async () => {
  ...
  if (fs.existsSync(path.join(projectRoot, formalRel))) {
    throw new Error('protected formal TGB file already exists; refusing concurrent overwrite');
  }
