# DreamerQi production operation: write the manually transcribed 2026-08-06
# official @TGB Hunan table, rebuild the same-day combined reason database,
# and verify the public source view.
#
# The 79 formal rows are supplied only through a date-bound encrypted GitHub
...
# all 79 review-eligible terminal-pool rows, backs up every touched artifact,
...
$expectedPayloadSha256 = '20771c8cb9aeea543d2f3a2b89c28a9ee8ae643975d354432c91f4284db5cbe1'
...
const articleUrl = 'https://www.tgb.cn/a/2u2El7xRP2c';
const articleTitle = '8.6\u6e56\u5357\u4eba\u6da8\u505c\u590d\u76d8+\u665a\u95f4\u6d88\u606f\u6c47\u603b';
const imageFile = 'image-01-06.png';
const imageUrl = 'https://image.tgb.cn/img/2026/08/06/apw5ks1wkbbo.png_760w.png';
const expectedImageLength = 891844;
const expectedImageSha256 = 'f5987489d0b923d35bb94f2c64be25ae45eda1e6c53822753e4d0034b47e4799';
const expectedCount = 79;
const expectedRawPoolCount = 79;
const expectedExcludedCodes = [];
const operationId = 'tgb-hunan-manual-20260806';
