# DreamerQi production operation: write the manually transcribed 2026-08-26
# official @TGB Hunan table, rebuild the same-day combined reason database,
# and verify the public source view.
#
# The 52 formal rows are supplied only through a date-bound encrypted GitHub
...
# all 52 review-eligible terminal-pool rows, backs up every touched artifact,
...
$expectedPayloadSha256 = '89ac892e050510027c653802d221bdb6318f622de81ce8859be908c937b76a89'
...
const articleUrl = 'https://www.tgb.cn/a/2uzSn8RLuWv';
const articleTitle = '8.26\u6e56\u5357\u4eba\u6da8\u505c\u590d\u76d8+\u665a\u95f4\u6d88\u606f\u6c47\u603b';
const imageFile = 'image-01-06.png';
const imageUrl = 'https://image.tgb.cn/img/2026/08/26/n8lnsnaq8g8p.png_760w.png';
const expectedImageLength = 644390;
const expectedImageSha256 = '32a6d6c2651fe43ed5eece818ae0ad4f0064f22aac58b47fe6f30997ae4725c8';
const expectedCount = 52;
const expectedRawPoolCount = 52;
const expectedExcludedCodes = [];
const operationId = 'tgb-hunan-manual-20260826';
