...
# 2026-08-27 @TGB Hunan manual review.
#
...
$day = '2026-08-27'
$expectedEligibleCount = 76
$baselineFile = Join-Path $project 'kpl-limitup-db\2026-08-27.json'
$formalFile = Join-Path $project 'kpl-limitup-main-reason-sources\tgb-hunan-structured\2026-08-27.json'
