# DreamerQi production operation: write the manually transcribed 2026-08-28
# official @TGB Hunan table, rebuild the same-day combined reason database,
# and verify the public source view.
#
# The 81 formal rows are supplied only through a date-bound encrypted GitHub
...
# all 81 review-eligible terminal-pool rows, backs up every touched artifact,
...
$expectedPayloadSha256 = '6755e6a95605b6791de79dfc441c59d1257f442217e11598097cfbefe37cab06'
...
const articleUrl = 'https://www.tgb.cn/a/2uD6GIwPL0s';
const articleTitle = '8.28\u6e56\u5357\u4eba\u6da8\u505c\u590d\u76d8+\u665a\u95f4\u6d88\u606f\u6c47\u603b';
const imageFile = 'image-01-06.png';
const imageUrl = 'https://image.tgb.cn/img/2026/08/28/o6cdrd8wuapm.png_760w.png';
const expectedImageLength = 876211;
const expectedImageSha256 = '8e2f1542914c01777d25014f5b3d77cc86b6434783637d8d335f23392b6eca74';
const expectedCount = 81;
const expectedRawPoolCount = 82;
const expectedExcludedCodes = ['920895'];
const operationId = 'tgb-hunan-manual-20260828';
