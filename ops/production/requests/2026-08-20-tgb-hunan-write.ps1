# DreamerQi production operation: write the manually transcribed 2026-08-20
# official @TGB Hunan table, rebuild the same-day combined reason database,
# and verify the public source view.
#
# The 78 formal rows are supplied only through a date-bound encrypted GitHub
...
# all 78 review-eligible terminal-pool rows, backs up every touched artifact,
...
$expectedPayloadSha256 = 'c9dae4e0eab76ad9ecbfdb7a2328ad962c9d6d81cdc64480a91fabed973bbfd5'
...
const articleUrl = 'https://www.tgb.cn/a/2upPwvChvWl';
const articleTitle = '8.20\u6e56\u5357\u4eba\u6da8\u505c\u590d\u76d8+\u665a\u95f4\u6d88\u606f\u6c47\u603b';
const imageFile = 'image-01-06.png';
const imageUrl = 'https://image.tgb.cn/img/2026/08/20/ug5p6lysc2om.png_760w.png';
const expectedImageLength = 910433;
const expectedImageSha256 = '1334a029c37d6148ab0c94b8423f8589118250e71a026e363152bff43dbae9b3';
const expectedCount = 78;
const expectedRawPoolCount = 79;
const expectedExcludedCodes = ['920344'];
const operationId = 'tgb-hunan-manual-20260820';
