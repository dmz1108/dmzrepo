...
# 2026-08-12 @TGB Hunan manual review.
#
...
$day = '2026-08-12'
$baselineFile = Join-Path $project 'kpl-limitup-db\2026-08-12.json'
$formalFile = Join-Path $project 'kpl-limitup-main-reason-sources\tgb-hunan-structured\2026-08-12.json'
...
if ($eligibleRows.Count -ne 91 -or $eligibleCodes.Count -ne 91) {
