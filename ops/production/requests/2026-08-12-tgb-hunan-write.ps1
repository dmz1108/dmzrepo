# DreamerQi production operation: write the manually transcribed 2026-08-12
# official @TGB Hunan table, rebuild the same-day combined reason database,
# and verify the public source view.
#
# The 91 formal rows are supplied only through a date-bound encrypted GitHub
...
# all 91 review-eligible terminal-pool rows, backs up every touched artifact,
...
$expectedPayloadSha256 = '94c8a9fdfd74d9b00dd76f2caf9012f6cbd645a77a2b1da3e7ac215b7386b61e'
...
const articleUrl = 'https://www.tgb.cn/a/2ucBhKEKOG9';
const articleTitle = '8.12\u6e56\u5357\u4eba\u6da8\u505c\u590d\u76d8+\u665a\u95f4\u6d88\u606f\u6c47\u603b';
const imageFile = 'image-01-06.png';
const imageUrl = 'https://image.tgb.cn/img/2026/08/12/m6d3qud9kunm.png_760w.png';
const expectedImageLength = 863142;
const expectedImageSha256 = '23ca24c1aeb3017fe441aafa399ff7b31354048e71078420f4c478a988b0118d';
const expectedCount = 91;
const expectedRawPoolCount = 92;
const expectedExcludedCodes = ['920856'];
const operationId = 'tgb-hunan-manual-20260812';
