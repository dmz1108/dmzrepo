# DreamerQi production operation: write the manually transcribed 2026-08-25
# official @TGB Hunan table, rebuild the same-day combined reason database,
# and verify the public source view.
#
# The 65 formal rows are supplied only through a date-bound encrypted GitHub
...
# all 65 review-eligible terminal-pool rows, backs up every touched artifact,
...
$expectedPayloadSha256 = 'da828edb16f9045181f06a89a446b3601bce76183f5d57799ee04d8d730914a1'
...
const articleUrl = 'https://www.tgb.cn/a/2uy7Jgoa8l6';
const articleTitle = '8.25\u6e56\u5357\u4eba\u6da8\u505c\u590d\u76d8+\u665a\u95f4\u6d88\u606f\u6c47\u603b';
const imageFile = 'image-01-06.png';
const imageUrl = 'https://image.tgb.cn/img/2026/08/25/jj9wkwjr3pv7.png_760w.png';
const expectedImageLength = 719980;
const expectedImageSha256 = '44ad0bdd1001811e65b0645e0bf99f885807dad494b1f8fa631e4a029cfdb6e4';
const expectedCount = 65;
const expectedRawPoolCount = 65;
const expectedExcludedCodes = [];
const operationId = 'tgb-hunan-manual-20260825';
