...
# 2026-08-11 @TGB Hunan manual review.
#
...
$day = '2026-08-11'
$baselineFile = Join-Path $project 'kpl-limitup-db\2026-08-11.json'
$formalFile = Join-Path $project 'kpl-limitup-main-reason-sources\tgb-hunan-structured\2026-08-11.json'
...
if ($eligibleRows.Count -ne 58 -or $eligibleCodes.Count -ne 58) {
