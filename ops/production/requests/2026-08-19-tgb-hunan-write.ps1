# DreamerQi production operation: write the manually transcribed 2026-08-19
# official @TGB Hunan table, rebuild the same-day combined reason database,
# and verify the public source view.
#
# The 36 formal rows are supplied only through a date-bound encrypted GitHub
...
# all 36 review-eligible terminal-pool rows, backs up every touched artifact,
...
$expectedPayloadSha256 = '7071183a6774cda893a1edc3b6c4ca9bf487373d6584ed05f46fac6087bc51cd'
...
const articleUrl = 'https://www.tgb.cn/a/2uonRBBKYdH';
const articleTitle = '8.19\u6e56\u5357\u4eba\u6da8\u505c\u590d\u76d8+\u665a\u95f4\u6d88\u606f\u6c47\u603b';
const imageFile = 'image-01-06.png';
const imageUrl = 'https://image.tgb.cn/img/2026/08/19/78527rdtju1o.png_760w.png';
const expectedImageLength = 415750;
const expectedImageSha256 = '256192d194c725dd7b2c5502a347e5ea0e0b1982b605bd617bcb983a387bda8a';
const expectedCount = 36;
const expectedRawPoolCount = 36;
const expectedExcludedCodes = [];
const operationId = 'tgb-hunan-manual-20260819';
