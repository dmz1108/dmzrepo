...
# 2026-08-17 @TGB Hunan manual review.
#
...
$day = '2026-08-17'
$expectedEligibleCount = 106
$baselineFile = Join-Path $project 'kpl-limitup-db\2026-08-17.json'
$formalFile = Join-Path $project 'kpl-limitup-main-reason-sources\tgb-hunan-structured\2026-08-17.json'
