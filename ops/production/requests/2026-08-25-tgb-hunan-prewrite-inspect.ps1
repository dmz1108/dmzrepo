...
# 2026-08-25 @TGB Hunan manual review.
#
...
$day = '2026-08-25'
$expectedEligibleCount = 65
$baselineFile = Join-Path $project 'kpl-limitup-db\2026-08-25.json'
$formalFile = Join-Path $project 'kpl-limitup-main-reason-sources\tgb-hunan-structured\2026-08-25.json'
