# DreamerQi production operation: write the manually transcribed 2026-08-17
# official @TGB Hunan table, rebuild the same-day combined reason database,
# and verify the public source view.
#
# The 106 formal rows are supplied only through a date-bound encrypted GitHub
...
# all 106 review-eligible terminal-pool rows, backs up every touched artifact,
...
$expectedPayloadSha256 = '715d7f1c2600c043056488c8e23e8f001ad11b22c2af2eac0914750365ac4a6c'
...
const articleUrl = 'https://www.tgb.cn/a/2ukUULM6lx6';
const articleTitle = '8.17\u6e56\u5357\u4eba\u6da8\u505c\u590d\u76d8+\u665a\u95f4\u6d88\u606f\u6c47\u603b';
const imageFile = 'image-01-07.png';
const imageUrl = 'https://image.tgb.cn/img/2026/08/17/9c4x2qu3q3zn.png_760w.png';
const expectedImageLength = 989124;
const expectedImageSha256 = '42747eedae5809cfb06bbf47d5f358ddc8e72e6bb3e266543f5f4bbc9c17dd03';
const expectedCount = 106;
const expectedRawPoolCount = 106;
const expectedExcludedCodes = [];
const operationId = 'tgb-hunan-manual-20260817';
