# DreamerQi production operation: write the manually transcribed 2026-08-07
# official @TGB Hunan table, rebuild the same-day combined reason database,
# and verify the public source view.
#
# The 74 formal rows are supplied only through a date-bound encrypted GitHub
...
# all 74 review-eligible terminal-pool rows, backs up every touched artifact,
...
$expectedPayloadSha256 = 'dc9e5d96824fddcb340991c5bd8705cda55dba5340852343524b4a137315589c'
...
const articleUrl = 'https://www.tgb.cn/a/2u4idr7VS3s';
const articleTitle = '8.7\u6e56\u5357\u4eba\u6da8\u505c\u590d\u76d8+\u665a\u95f4\u6d88\u606f\u6c47\u603b';
const imageFile = 'image-01-06.png';
const imageUrl = 'https://image.tgb.cn/img/2026/08/07/4x0yuaahostp.png_760w.png';
const expectedImageLength = 848440;
const expectedImageSha256 = '046f2ad249f0029aaf7247bb42eeb25e6b0e74a465d31ff569d5e3ad569018cd';
const expectedCount = 74;
const expectedRawPoolCount = 74;
const expectedExcludedCodes = [];
const operationId = 'tgb-hunan-manual-20260807';
