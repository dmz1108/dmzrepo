...
# 2026-08-07 @TGB Hunan manual review.
#
...
$day = '2026-08-07'
$baselineFile = Join-Path $project 'kpl-limitup-db\2026-08-07.json'
$formalFile = Join-Path $project 'kpl-limitup-main-reason-sources\tgb-hunan-structured\2026-08-07.json'
...
if ($eligibleRows.Count -ne 74 -or $eligibleCodes.Count -ne 74) {
