# DreamerQi production operation: write the manually transcribed 2026-08-18
...
$expectedPayloadSha256 = 'e63932951881de0e35116562ccb9df0446b4c833e901356a30484874528327c9'
...
const articleUrl = 'https://www.tgb.cn/a/2umBA1BXLzX';
const articleTitle = '8.18\u6e56\u5357\u4eba\u6da8\u505c\u590d\u76d8+\u665a\u95f4\u6d88\u606f\u6c47\u603b';
const imageFile = 'image-01-06.png';
const imageUrl = 'https://image.tgb.cn/img/2026/08/18/9agup14l3mz0.png_760w.png';
const expectedImageLength = 847643;
const expectedImageSha256 = '821b8f54a372048365ed450dd0ad65a2093b5a5fc06b0d7484c852cf7a428505';
const expectedCount = 78;
const expectedRawPoolCount = 79;
const expectedExcludedCodes = ['920087'];
const operationId = 'tgb-hunan-manual-20260818';
