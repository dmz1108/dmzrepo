# DreamerQi production operation: write the manually transcribed 2026-08-27
# official @TGB Hunan table, rebuild the same-day combined reason database,
# and verify the public source view.
#
# The 76 formal rows are supplied only through a date-bound encrypted GitHub
...
# all 76 review-eligible terminal-pool rows, backs up every touched artifact,
...
$expectedPayloadSha256 = 'd96a1749649e50764c4da12015c0abaab0db456cd80479f68a1ba3c73a96fcea'
...
const articleUrl = 'https://www.tgb.cn/a/2uBuay3MSqq';
const articleTitle = '8.27\u6e56\u5357\u4eba\u6da8\u505c\u590d\u76d8+\u665a\u95f4\u6d88\u606f\u6c47\u603b';
const imageFile = 'image-01-06.png';
const imageUrl = 'https://image.tgb.cn/img/2026/08/27/96bibhewb9t9.png_760w.png';
const expectedImageLength = 801096;
const expectedImageSha256 = '18e03a34538b496c7982d6c6c52a78d694ade3b45e9f86ea262a264d2b5ebf2c';
const expectedCount = 76;
const expectedRawPoolCount = 77;
const expectedExcludedCodes = ['920895'];
const operationId = 'tgb-hunan-manual-20260827';
