...
# 2026-08-28 @TGB Hunan manual review.
#
...
$baselineFile = Join-Path $project 'kpl-limitup-db\2026-08-28.json'
$formalFile = Join-Path $project 'kpl-limitup-main-reason-sources\tgb-hunan-structured\2026-08-28.json'
