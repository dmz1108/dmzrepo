...
# 2026-08-14 @TGB Hunan manual review.
#
...
$day = '2026-08-14'
$baselineFile = Join-Path $project 'kpl-limitup-db\2026-08-14.json'
$formalFile = Join-Path $project 'kpl-limitup-main-reason-sources\tgb-hunan-structured\2026-08-14.json'
...
if ($eligibleRows.Count -ne 62 -or $eligibleCodes.Count -ne 62) {
