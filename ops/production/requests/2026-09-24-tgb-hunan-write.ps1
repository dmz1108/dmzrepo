# DreamerQi production operation: write the manually transcribed 2026-09-24
...
$expectedPayloadSha256 = '3d13e127c00963e84ec06cd4e621b67601d4a0ffd27b3d7a0eee7c3263c36e2c'
...
const articleUrl = 'https://www.tgb.cn/a/2vlWvkwS6PU';
const articleTitle = '9.24\u6e56\u5357\u4eba\u6da8\u505c\u590d\u76d8+\u665a\u95f4\u6d88\u606f\u6c47\u603b';
const imageFile = 'image-01-06.png';
const imageUrl = 'https://image.tgb.cn/img/2026/09/24/hf3fsvfi0tn6.png_760w.png';
const expectedImageLength = 590626;
const expectedImageSha256 = '329c93a7e677a990b7224f105f55c87119003d1116e07b4ad128d076cacaf924';
const expectedCount = 51;
const expectedRawPoolCount = 52;
const expectedExcludedCodes = ['920748'];
const operationId = 'tgb-hunan-manual-20260924';
