...
# 2026-08-13 @TGB Hunan manual review.
#
...
$day = '2026-08-13'
$baselineFile = Join-Path $project 'kpl-limitup-db\2026-08-13.json'
$formalFile = Join-Path $project 'kpl-limitup-main-reason-sources\tgb-hunan-structured\2026-08-13.json'
...
if ($eligibleRows.Count -ne 59 -or $eligibleCodes.Count -ne 59) {
