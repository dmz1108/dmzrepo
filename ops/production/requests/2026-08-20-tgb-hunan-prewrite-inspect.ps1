...
# 2026-08-20 @TGB Hunan manual review.
#
...
$baselineFile = Join-Path $project 'kpl-limitup-db\2026-08-20.json'
$formalFile = Join-Path $project 'kpl-limitup-main-reason-sources\tgb-hunan-structured\2026-08-20.json'
