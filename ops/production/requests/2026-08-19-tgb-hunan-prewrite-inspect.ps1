...
# 2026-08-19 @TGB Hunan manual review.
#
...
$day = '2026-08-19'
$expectedEligibleCount = 36
$baselineFile = Join-Path $project 'kpl-limitup-db\2026-08-19.json'
$formalFile = Join-Path $project 'kpl-limitup-main-reason-sources\tgb-hunan-structured\2026-08-19.json'
