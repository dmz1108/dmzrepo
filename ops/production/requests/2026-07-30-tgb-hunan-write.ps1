# DreamerQi production operation: write the manually transcribed 2026-07-30
# official @TGB Hunan table, rebuild the same-day combined reason database,
# and verify the public source view.
#
# The 51 formal rows are supplied only through a date-bound encrypted GitHub
...
$expectedPayloadSha256 = '88e1b3b2ca254ace147a8d1cb866b92ee5524a29b026372a3febe53371d8b824'
...
const articleUrl = 'https://www.tgb.cn/a/2tR2UnZgD9B';
const articleTitle = '7.30\u6e56\u5357\u4eba\u6da8\u505c\u590d\u76d8+\u665a\u95f4\u6d88\u606f\u6c47\u603b';
const imageFile = 'image-01-06.png';
const imageUrl = 'https://image.tgb.cn/img/2026/07/30/1tl1y65pckqi.png_760w.png';
const expectedImageLength = 585191;
const expectedImageSha256 = '7c7f27040c109b4ce46b6595febb92e78184351ec68e428f4f32decf4420f59f';
const expectedCount = 51;
const expectedRawPoolCount = 52;
const expectedExcludedCodes = ['920685'];
const operationId = 'tgb-hunan-manual-20260730';
