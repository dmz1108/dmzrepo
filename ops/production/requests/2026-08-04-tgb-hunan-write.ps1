# DreamerQi production operation: write the manually transcribed 2026-08-04
# official @TGB Hunan table, rebuild the same-day combined reason database,
# and verify the public source view.
#
# The 137 formal rows are supplied only through a date-bound encrypted GitHub
...
# all 137 review-eligible terminal-pool rows, backs up every touched artifact,
...
$expectedPayloadSha256 = 'f3ccd690f63dffae49ea6fcb3831f7e0aee9b6814ff63816cc6d5551b1bb3b34'
...
const articleUrl = 'https://www.tgb.cn/a/2tZtbfK6FHu';
const articleTitle = '8.4\u6e56\u5357\u4eba\u6da8\u505c\u590d\u76d8+\u665a\u95f4\u6d88\u606f\u6c47\u603b';
const imageFile = 'image-01-07.png';
const imageUrl = 'https://image.tgb.cn/img/2026/08/04/y6kboqrgymmm.png_760w.png';
const expectedImageLength = 1278534;
const expectedImageSha256 = '39e306418b9da97e585b6025b55cd162251d55cf5f094e600de45d6f628556e2';
const expectedCount = 137;
const expectedRawPoolCount = 138;
const expectedExcludedCodes = ['920092'];
const operationId = 'tgb-hunan-manual-20260804';
