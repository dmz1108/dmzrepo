# DreamerQi production operation: write the manually transcribed 2026-08-03
# official @TGB Hunan table, rebuild the same-day combined reason database,
# and verify the public source view.
#
# The 75 formal rows are supplied only through a date-bound encrypted GitHub
...
# all 75 review-eligible terminal-pool rows, backs up every touched artifact,
...
$expectedPayloadSha256 = '145938377f92857c9ce9f30290ef1c8b96e6621ee79aaf64fadfb75f003f0f2f'
...
const articleUrl = 'https://www.tgb.cn/a/2tXVJyaw2tR';
const articleTitle = '8.3\u6e56\u5357\u4eba\u6da8\u505c\u590d\u76d8+\u665a\u95f4\u6d88\u606f\u6c47\u603b';
const imageFile = 'image-01-06.png';
const imageUrl = 'https://image.tgb.cn/img/2026/08/03/koh98pekcc7l.png_760w.png';
const expectedImageLength = 784312;
const expectedImageSha256 = '5d36e9bb7edc9009b12da91f7f46234c071942da1c1ed880876a9c570c6256eb';
const expectedCount = 75;
const expectedRawPoolCount = 75;
const expectedExcludedCodes = [];
const operationId = 'tgb-hunan-manual-20260803';
