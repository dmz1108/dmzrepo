...
# 2026-08-06 @TGB Hunan manual review.
#
...
$day = '2026-08-06'
$baselineFile = Join-Path $project 'kpl-limitup-db\2026-08-06.json'
$formalFile = Join-Path $project 'kpl-limitup-main-reason-sources\tgb-hunan-structured\2026-08-06.json'
...
if ($eligibleRows.Count -ne 79 -or $eligibleCodes.Count -ne 79) {
