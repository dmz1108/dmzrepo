# DreamerQi production operation: write the manually transcribed 2026-08-05
# official @TGB Hunan table, rebuild the same-day combined reason database,
# and verify the public source view.
#
# The 102 formal rows are supplied only through a date-bound encrypted GitHub
...
# all 102 review-eligible terminal-pool rows, backs up every touched artifact,
...
$expectedPayloadSha256 = '4111c6088d1fe69cc2627b2484636d27afccc834ef731601d79e8b491d97adbf'
...
const articleUrl = 'https://www.tgb.cn/a/2u10yPnYbir';
const articleTitle = '8.5\u6e56\u5357\u4eba\u6da8\u505c\u590d\u76d8+\u665a\u95f4\u6d88\u606f\u6c47\u603b';
const imageFile = 'image-01-06.png';
const imageUrl = 'https://image.tgb.cn/img/2026/08/05/hgiet2qf4nmm.png_760w.png';
...
function excludedFromReview(code, name) {
  return code === ownerExcludedNonLimitUpCode
    || /^[489]/.test(code)
    || /(?:\*?ST|\u9000)/i.test(name)
    || /^[NC]/i.test(name);
}
