# DreamerQi production operation: write the manually transcribed 2026-08-31
# official @TGB Hunan table, rebuild the same-day combined reason database,
# and verify the public source view.
#
# The 86 formal rows are supplied only through a date-bound encrypted GitHub
...
# all 86 review-eligible terminal-pool rows, backs up every touched artifact,
...
$expectedPayloadSha256 = 'a435ae415c7bad6fe59246f674d637ffd4fa24ffbb352d75cadf6a144e46fee4'
...
const articleUrl = 'https://www.tgb.cn/a/2uI68eHSbbC';
const articleTitle = '8.31\u6e56\u5357\u4eba\u6da8\u505c\u590d\u76d8+\u665a\u95f4\u6d88\u606f\u6c47\u603b';
const imageFile = 'image-01-06.png';
const imageUrl = 'https://image.tgb.cn/img/2026/08/31/pjyk5kv8ppkd.png_760w.png';
const expectedImageLength = 1018426;
const expectedImageSha256 = '5aeb7988fe8276f399a0afed0f5f49a8dcae6715141e9b6c95be40e8a3784116';
const expectedCount = 86;
const expectedRawPoolCount = 88;
const expectedExcludedCodes = ['920021', '920223'];
const operationId = 'tgb-hunan-manual-20260831';
