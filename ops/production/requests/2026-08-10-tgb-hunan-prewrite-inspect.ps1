...
# 2026-08-10 @TGB Hunan manual review.
#
...
$day = '2026-08-10'
$baselineFile = Join-Path $project 'kpl-limitup-db\2026-08-10.json'
$formalFile = Join-Path $project 'kpl-limitup-main-reason-sources\tgb-hunan-structured\2026-08-10.json'
...
if ($eligibleRows.Count -ne 99 -or $eligibleCodes.Count -ne 99) {
