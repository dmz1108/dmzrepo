...
# 2026-08-24 @TGB Hunan manual review.
#
...
$day = '2026-08-24'
$expectedEligibleCount = 46
$baselineFile = Join-Path $project 'kpl-limitup-db\2026-08-24.json'
$formalFile = Join-Path $project 'kpl-limitup-main-reason-sources\tgb-hunan-structured\2026-08-24.json'
