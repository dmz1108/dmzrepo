# DreamerQi production operation: write the manually transcribed 2026-09-23
# official @TGB Hunan table, rebuild the same-day combined reason database,
# and verify the public source view.
#
# The 51 formal rows are supplied through a date-bound temporary payload file.
# They are not tracked in Git or printed here.
# The script verifies the payload and official-image SHA-256 values, reconciles
# all 51 review-eligible terminal-pool rows, backs up every touched artifact,
...
$expectedPayloadSha256 = '59dc1dc67e097c380b401ca2d64f1402f05c18b19cf6d74dc3fd3a3a2b1eaad6'
...
const articleUrl = 'https://www.tgb.cn/a/2vkiqZe1mF4';
const articleTitle = '9.23\u6e56\u5357\u4eba\u6da8\u505c\u590d\u76d8+\u665a\u95f4\u6d88\u606f\u6c47\u603b';
const imageFile = 'image-01-06.png';
const imageUrl = 'https://image.tgb.cn/img/2026/09/23/3wpxgwg9iyvz.png_760w.png';
const expectedImageLength = 642372;
const expectedImageSha256 = 'd5eb63b259ec5af7f93f295f17b0d8a99e498d9f3d18a4a607c437529d20715f';
const expectedCount = 51;
const expectedRawPoolCount = 51;
const expectedExcludedCodes = [];
const operationId = 'tgb-hunan-manual-20260923';
...
const expectedNameDifferences = [
  {
    ...
    sourceName: '\u6167\u667a\u5fae',
    baselineName: '\u6167\u667a\u5fae-U',
    normalization: 'explicit-source-alias',
  },
];
