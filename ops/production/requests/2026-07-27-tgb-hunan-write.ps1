# DreamerQi production operation: write the manually transcribed 2026-07-27
# official @TGB Hunan table, rebuild the same-day combined reason database,
# and verify the public source view.
#
# The 111 formal rows are supplied only through a date-bound encrypted GitHub
...
# all 111 review-eligible terminal-pool rows, backs up every touched artifact,
...
$expectedPayloadSha256 = '00f78fb9088fb57d6d271b538166bacea5cd64bcf75cf286dc1ec4bb3e2ad955'
...
const articleUrl = 'https://www.tgb.cn/a/2tM2uLbdlIs';
const articleTitle = '7.27\u6e56\u5357\u4eba\u6da8\u505c\u590d\u76d8+\u665a\u95f4\u6d88\u606f\u6c47\u603b';
const imageFile = 'image-01-06.png';
const imageUrl = 'https://image.tgb.cn/img/2026/07/27/f2wf0q804jjf.png_760w.png';
const expectedImageLength = 1045427;
const expectedImageSha256 = '7ae39e7b6227e2eb98abbdfb92473aea0ed84cd559e9eb3623b0c4d2e8be773c';
const expectedCount = 111;
const expectedRawPoolCount = 111;
const operationId = 'tgb-hunan-manual-20260727';
