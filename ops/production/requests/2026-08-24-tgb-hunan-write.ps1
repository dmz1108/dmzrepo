# DreamerQi production operation: write the manually transcribed 2026-08-24
...
# all 46 review-eligible terminal-pool rows, backs up every touched artifact,
...
$expectedPayloadSha256 = '5111ba4722637df742609d8c04251e77a1a68f4bb37fb1433c55f4e43cbaa675'
...
const articleUrl = 'https://www.tgb.cn/a/2uwthn6EfR5';
const articleTitle = '8.24\u6e56\u5357\u4eba\u6da8\u505c\u590d\u76d8+\u665a\u95f4\u6d88\u606f\u6c47\u603b';
const imageFile = 'image-01-06.png';
const imageUrl = 'https://image.tgb.cn/img/2026/08/24/d7i1sb5a76om.png_760w.png';
const expectedImageLength = 559319;
const expectedImageSha256 = 'ca7433198be529fa7c75567e501b88e6d59aece70dde1c5b2f2b3b26e46f464f';
const expectedCount = 46;
const expectedRawPoolCount = 46;
const expectedExcludedCodes = [];
const operationId = 'tgb-hunan-manual-20260824';
