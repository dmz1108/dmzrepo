...
- 统一“AI视频、快手概念、小红书概念、文化传媒概念、出海广告”等为短剧游戏细分
  家族；`AI应用` 保持独立宽口径，不再等同于算力 AI。主因同时包含宽词和具体词时，
  具体词优先，避免“AI应用+出海广告”被宽词错误吸收。
...
- 同花顺 AI视频使用双标识：内部概念 `plateId=309118`，页面指数代码
  ...
  伪造它是该单板直接成分；系统通过“快手/小红书/AI视频同属短剧游戏”消费真实
  同族证据。当天同花顺涨停原因
...
- AI视频的内部 `plateId=309118` 与指数代码 `886068` 指向同一板块；该单板源不含
  蓝色光标，因此不把它伪造成直接成分。归并的是主线家族，不是篡改来源成分股。
