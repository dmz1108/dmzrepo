...
assert(html.includes('<link href="/vendor/review-workbench.css?v=20260718" rel="stylesheet">'));
assert(html.includes('<header class="review-hero">'));
assert(html.includes('<nav class="review-source-tabs" aria-label="复盘数据来源">'));
