...
(async () => {
  ...
  A(JSON.stringify(Object.keys(out.top[0]).sort()) === JSON.stringify(['certainty','key','l2ScanState','l2VerificationStatus','leader','leaders','predictScore','rank','score','stage','star','theme'].sort()), 'top 元素保留旧字段并新增 leaders/L2验证及页面状态');
